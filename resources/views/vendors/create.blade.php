    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('vendors.index') }}" class="btn btn-primary d-flex align-items-center">
                    <i class="ti ti-arrow-left"></i>
                </a>
                
                    <h2 class="page-title mb-0">Tambah Data Vendor</h2>
            ...
            <div class="card-body px-5 py-4">
                <form action="{{ route('vendors.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4 mt-2">
                            <div class="col-md-6">
                                ...
                                <select name="user_province_id" id="user_province" 
                                        class="form-select select2 @error('user_province_id') is-invalid @enderror">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="user_city_id" id="user_city" 
                                        class="form-select select2 @error('user_city_id') is-invalid @enderror">
                            ...
                            <div class="col-md-5">
                                ...
                                <select name="user_district_id" id="user_district" 
                                        class="form-select select2 @error('user_district_id') is-invalid @enderror">
                            ...
                            <div class="col-md-5">
                                ...
                                <select name="user_sub_district_id" id="user_sub_district" 
                                        class="form-select select2 @error('user_sub_district_id') is-invalid @enderror">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="user_postal_code_id" id="user_postal_code" 
                                        class="form-select select2 @error('user_postal_code_id') is-invalid @enderror">
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="form-label required">ID Vendor</label>
                                <input type="text" id="vendor_id" name="vendor_id" class="form-control" required readonly>
                                @error('vendor_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <input type="number" name="vendor_phone" class="form-control @error('vendor_phone') is-invalid @enderror" value="{{ old('vendor_phone') }}">
                                    @error('vendor_phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="section-block mb-3">
                        ...
                        <div class="section-block mb-5">
                            <h3 class="fw-semibold mb-3 border-bottom pb-2">Alamat Vendor</h3>
                            <div class="row g-4">
                                
                                
                                <div class="col-12">
                                    <label class="form-label">Alamat Lengkap</label>
                                    <textarea name="vendor_address" rows="2" class="form-control @error('vendor_address') is-invalid @enderror">{{ old('vendor_address') }}</textarea>
                            ...
                            <div class="row g-4 mt-2">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Kabupaten/Kota</label>
                                    <select name="city_id" id="city" class="form-select select2" value="{{ old('city') }}">
                                        <option value="">-- Pilih Kota --</option>
                                    </select>
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label">Kecamatan</label>
                                    <select name="district_id" id="district" class="form-select select2" value="{{ old('district') }}">
                                        <option value="">-- Pilih Kecamatan --</option>
                                    </select>
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label">Kelurahan</label>
                                    <select name="sub_district_id" id="sub_district" class="form-select select2" value="{{ old('sub_district') }}">
                                        <option value="">-- Pilih Kelurahan --</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Kode Pos</label>
                                    <select name="postal_code_id" id="postal_code" class="form-select select2" value="{{ old('postal_code') }}">
                                        <option value="">-- Pilih Kode Pos --</option>
                                    </select>
                                </div>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const vendor_idField = document.getElementById('vendor_id'); // ubah nama biar sesuai

        // Pastikan elemen ada dulu
        if (!vendor_idField) return;

        fetch('{{ route('vendors.generateVendorId') }}', {
            headers: {
        ...
        .then(data => {
            if (data.vendor_id) {
                vendor_idField.value = data.vendor_id; // variabel sekarang valid
            }
        })
        .catch(error => console.error('❌ Error fetching vendor_id:', error));
    });
</script>
...
$(document).ready(function() {
    $('#same_address').on('change', function() {
        if ($(this).is(':checked')) {
            ...
            $('[name="vendor_address"]').val($('[name="address"]').val());
            $('[name="vendor_name"]').val($('[name="fullname"]').val());
            $('[name="vendor_phone"]').val($('[name="phone"]').val());

            // Disable field
            $('#province, #city, #district, #sub_district, #postal_code, [name="vendor_address"], [name="vendor_name"], [name="vendor_phone"]')
                .attr('readonly', true)
