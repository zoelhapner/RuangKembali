                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table id="tableVendors" class="table card-table table-vcenter text-nowrap" >
                                <thead>
                                    <tr>
                                        <th width="5%">No</th>
                                        <th>ID Vendor</th>
...
@push('js')
    <script>
        $(function() {
            ...
            const table = $('#tableVendors').DataTable({
                scrollY: '500px',
                scrollX: true,
                scrollCollapse: true,
            ...
            $('table').on('click', '.delete-vendors', function () {
            const vendorsId = $(this).data('id');
