        ...
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('vendors.index') }}" class="btn btn-primary d-flex align-items-center">
                    ...
                    <h2 class="page-title mb-0">Edit Data vendor</h2>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body px-5 py-4">
                <form action="{{ route('vendors.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="section-block mb-5">
                        <h3 class="fw-semibold mb-3 border-bottom pb-2">Data vendor</h3>
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="form-label required">ID vendor </label>
                                <input type="text" id="vendor_id" name="vendor_id" class="form-control" value="{{ old('vendor_id', $vendor->vendor_id) }}" required readonly>
                                @error('vendor_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $vendor->phone) }}">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="same_address" name="same_address"
                            @if(
                                $vendor->province_id == $user->province_id &&
                                $vendor->city_id == $user->city_id &&
                                $vendor->district_id == $user->district_id &&
                                $vendor->sub_district_id == $user->sub_district_id &&
                                $vendor->postal_code_id == $user->postal_code_id
                            ) checked @endif>
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <label class="form-label">Alamat Lengkap</label>
                                <textarea name="address" rows="2" class="form-control @error('address') is-invalid @enderror">{{ old('address', $vendor->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
