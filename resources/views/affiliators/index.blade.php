                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table id="tableaffiliators" class="table card-table table-vcenter text-nowrap" >
                                <thead>
                                    <tr>
                                        <th width="5%">No</th>
                                        <th>ID Affiliator</th>
...
@can('tambah data affiliator')
<a href="{{ route('affiliators.create') }}"
