    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('affiliators.index') }}" class="btn btn-primary d-flex align-items-center" style="margin-left: 30px;">
                    <i class="ti ti-arrow-left"></i>
                </a>
                
                    <h2 class="page-title mb-0">Edit Data Affiliator</h2>
    ...
    <div class="container-xl">
        <div class="card shadow-sm border-0">
            <div class="card-body px-5 py-4">
                <form action="{{ route('affiliators.update', $affiliator->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    @if ($errors->any())
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="form-label required">Nomor Identitas affiliator (nia)</label>
                                <input type="text" id="nia" name="nia" class="form-control" value="{{ old('nia', $affiliator->nia) }}" readonly>
                                @error('nia')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="membership" class="form-select select2">
                                    <option value="">-- Pilih --</option>
                                    <option value="1" {{ old('membership', $affiliator->membership) == 1 ? 'selected' : '' }}>Putih</option>
                                    <option value="2" {{ old('membership', $affiliator->membership) == 2 ? 'selected' : '' }}>Biru</option>
                                    <option value="3" {{ old('membership', $affiliator->membership) == 3 ? 'selected' : '' }}>Merah</option>
                                </select>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Saldo</label>
                                <input type="number" id="saldo" name="saldo" class="form-control @error('saldo') is-invalid @enderror" value="{{ old('saldo', $affiliator->saldo) }}" required>
                                @error('saldo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
