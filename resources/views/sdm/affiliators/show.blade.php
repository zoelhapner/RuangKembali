...
<div class="container-xl" style="padding-top:80px">
        ...
        <div class="row align-items-center" style="padding-bottom:20px">
            <div class="col d-flex align-items-center">
                <a href="{{ route('affiliators.index') }}" class="btn btn-primary d-flex align-items-center">
        ...
        <div class="tab-pane fade show active" id="tab-personal" role="tabpanel">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('affiliators.edit', $affiliator->id) }}" class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" title="Ubah Detail">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="text-muted small mt-2">Kategori affiliator</div>
                                    <div class="fw-bold">{{ $affiliator->readable_membership ?? '-' }}</div>
                                </div>
                                <div class="col-md-6">
                                ...
                                {{-- <div class="col-md-4">
                                    ...
                                    <span class="badge {{ $affiliator->is_active ? 'bg-success' : 'bg-danger' }}">
                                        {{ $affiliator->status_text }}
                                    </span>
                                </div> --}}
                            </div>
                        </div>
                ...
                <div class="card-body text-center">
                    @php
                        $color = [
                            ...
                            'Biru' => 'warning',
                            'Merah' => 'info',
                        ][$affiliator->membership] ?? 'secondary';
                    @endphp
                    ...
                    <h3 class="fw-bold text-capitalize">{{ $affiliator->readable_loyalty_level }}</h3>
                    <p class="text-muted">
                        Tingkatan membership untuk menambah komisi yang didapatkan. 
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <div class="fw-bold">{{ $affiliator->shipping_name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Nomor Handphone</div>
                            <div class="fw-bold">{{ $affiliator->shipping_phone ?? '-' }}</div>
                        </div>
                        <div class="col-12">
                            <div class="text-muted small">Alamat Lengkap</div>
                            <div class="fw-bold">{{ $affiliator->shipping_address ?? '-' }}</div>
                        </div>

                        <div class="col-md-3">
                            <div class="text-muted small">Kelurahan</div>
                            <div class="fw-bold">{{ $affiliator->subDistrict->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Kecamatan</div>
                            <div class="fw-bold">{{ $affiliator->district->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Kabupaten/Kota</div>
                            <div class="fw-bold">{{ $affiliator->city->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Provinsi</div>
                            <div class="fw-bold">{{ $affiliator->province->name ?? '-' }}</div>
                        </div>

                        <div class="col-md-3">
                            <div class="text-muted small">Kode Pos</div>
                            <div class="fw-bold">{{ $affiliator->postalCode->postal_code ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Catatan</div>
                            <div class="fw-bold">{{ $affiliator->notes ?? '-' }}</div>
                        </div>
                    </div>
                </div>
            </div>
