        ...
        <div class="row align-items-center" style="padding-bottom:20px">
            <div class="col d-flex align-items-center">
                <a href="{{ route('members.index') }}" class="btn btn-primary d-flex align-items-center">
                    ...
                    <h2 class="page-title">Detail member</h2>
            </div>
        </div>
            ...
            <div class="tab-pane fade show active" id="tab-personal" role="tabpanel">
                ...
                <div class="card mb-4 shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('members.edit', $member->id) }}" class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" title="Ubah Detail">
                        ...
                        <div class="row align-items-center mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-muted small mt-2">Kategori member</div>
                                        <div class="fw-bold">{{ $member->readable_category ?? '-' }}</div>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="card-body text-center">
                        @php
                            $color = [
                                ...
                                'gold' => 'warning',
                                'platinum' => 'info',
                            ][$member->loyalty_level] ?? 'secondary';
                        @endphp
                        ...
                        <h3 class="fw-bold text-capitalize">{{ $member->readable_loyalty_level }}</h3>
                        <p class="text-muted">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <div class="fw-bold">{{ $member->shipping_name ?? '-' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-muted small">Nomor Handphone</div>
                                <div class="fw-bold">{{ $member->shipping_phone ?? '-' }}</div>
                            </div>
                            <div class="col-12">
                                <div class="text-muted small">Alamat Lengkap</div>
                                <div class="fw-bold">{{ $member->shipping_address ?? '-' }}</div>
                            </div>

                            <div class="col-md-3">
                                <div class="text-muted small">Kelurahan</div>
                                <div class="fw-bold">{{ $member->subDistrict->name ?? '-' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-muted small">Kecamatan</div>
                                <div class="fw-bold">{{ $member->district->name ?? '-' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-muted small">Kabupaten/Kota</div>
                                <div class="fw-bold">{{ $member->city->name ?? '-' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-muted small">Provinsi</div>
                                <div class="fw-bold">{{ $member->province->name ?? '-' }}</div>
                            </div>

                            <div class="col-md-3">
                                <div class="text-muted small">Kode Pos</div>
                                <div class="fw-bold">{{ $member->postalCode->postal_code ?? '-' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-muted small">Catatan</div>
                                <div class="fw-bold">{{ $member->notes ?? '-' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
