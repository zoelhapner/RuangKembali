    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('partners.index') }}" class="btn btn-primary d-flex align-items-center" style="margin-left: 30px;">
                    <i class="ti ti-arrow-left"></i>
                </a>
                
                    <h2 class="page-title mb-0">Edit Data architect</h2>
            ...
            <div class="card-body px-5 py-4">
                <form action="{{ route('partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="section-block mb-5">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="gender" class="form-select select2" value="{{ old('gender') }}">
                            ...
                            <div class="row g-4 mt-2">
                                <div class="col-md-6">
                                    <label class="form-label">Provinsi</label>
                                        <select name="user_province_id" id="user_province" class="form-select select2">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Kabupaten/Kota</label>
                                                <select name="user_city_id" id="user_city" class="form-select select2">
                                ...
                                <div class="col-md-5">
                                    <label class="form-label">Kecamatan</label>
                                                <select name="user_district_id" id="user_district" class="form-select select2">
                                ...
                                <div class="col-md-5">
                                    <label class="form-label">Kelurahan</label>
                                                <select name="user_sub_district_id" id="user_sub_district" class="form-select select2">
                                ...
                                <div class="col-md-2">
                                    <label class="form-label">Kode Pos</label>
                                                <select name="user_postal_code_id" id="user_postal_code" class="form-select select2">
                                                    <option value="">-- Pilih kelurahan --</option>
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="form-label required">Nomor Identitas Mitra </label>
                                <input type="text" id="architect_id" name="architect_id" class="form-control" value="{{ old('architect_id', $partner->architect_id) }}" readonly>
                                @error('architect_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="architect_name" class="form-control @error('architect_name') is-invalid @enderror" value="{{ old('architect_name', $partner->architect_name) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="architect_phone" class="form-control @error('architect_phone') is-invalid @enderror" value="{{ old('architect_phone', $partner->architect_phone) }}">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="same_address" name="same_address"
                            @if(
                                $partner->province_id == $user->province_id &&
                                $partner->city_id == $user->city_id &&
                                $partner->district_id == $user->district_id &&
                                $partner->sub_district_id == $user->sub_district_id &&
                                $partner->postal_code_id == $user->postal_code_id
                            ) checked @endif>
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <label class="form-label">Alamat Lengkap</label>
                                <textarea name="architect_address" rows="2" class="form-control @error('architect_address') is-invalid @enderror">{{ old('architect_address', $partner->architect_address) }}</textarea>
