    ...
    <div class="row align-items-center" style="padding-bottom:20px">
        <div class="col d-flex align-items-center">
            <a href="{{ route('partners.index') }}" class="btn btn-primary d-flex align-items-center">
                ...
                <h2 class="page-title">Detail Arsitek</h2>
        </div>
    </div>
        ...
        <div class="tab-pane fade show active" id="tab-personal" role="tabpanel">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('partners.edit', $partner->id) }}" class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" title="Ubah Detail">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="row g-3">
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="text-muted small mt-2">Kategori architect</div>
                                    <div class="fw-bold">{{ $partner->readable_category ?? '-' }}</div>
                                </div> --}}
                                <div class="col-md">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <div class="fw-bold">{{ $partner->architect_name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Nomor HP Usaha</div>
                            <div class="fw-bold">{{ $partner->architect_phone ?? '-' }}</div>
                        </div>
                        <div class="col-12">
                            <div class="text-muted small">Alamat Lengkap Usaha</div>
                            <div class="fw-bold">{{ $partner->architect_address ?? '-' }}</div>
                        </div>

                        <div class="col-md-3">
                            <div class="text-muted small">Kelurahan</div>
                            <div class="fw-bold">{{ $partner->subDistrict->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Kecamatan</div>
                            <div class="fw-bold">{{ $partner->district->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Kabupaten/Kota</div>
                            <div class="fw-bold">{{ $partner->city->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Provinsi</div>
                            <div class="fw-bold">{{ $partner->province->name ?? '-' }}</div>
                        </div>

                        <div class="col-md-3">
                            <div class="text-muted small">Kode Pos</div>
                            <div class="fw-bold">{{ $partner->postalCode->postal_code ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Catatan</div>
                            <div class="fw-bold">{{ $partner->notes ?? '-' }}</div>
                        </div>
                    </div>
                </div>
            </div>
