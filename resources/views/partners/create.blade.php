    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('partners.index') }}" class="btn btn-primary d-flex align-items-center">
            ...
            <div class="card-body px-5 py-4">
                <form action="{{ route('partners.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="identity_number" class="form-control @error('identity_number') is-invalid @enderror" value="{{ old('identity_number') }}">
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="form-label required">ID Mitra</label>
                        ...
                        <div class="section-block mb-5">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="architect_name" class="form-control @error('architect_name') is-invalid @enderror" value="{{ old('architect_name') }}">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Nomor Telpon Usaha</label>
                                    <input type="number" name="architect_phone" class="form-control @error('architect_phone') is-invalid @enderror" value="{{ old('architect_phone') }}">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        fetch('{{ route('partners.generateArchitectId') }}', {
            headers: {
