        ...
        $(function() {
            ...
            const table = $('#tableArchitects').DataTable({
                ...
                columns: [
                    ...
                    { data: 'architect_name', name: 'architect_name' },
                    { data: 'architect_phone', name: 'architect_phone' },
            ...
            $('table').on('click', '.delete-architect', function () {
            const architectId = $(this).data('id');
