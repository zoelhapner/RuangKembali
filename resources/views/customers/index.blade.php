        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                 @can('tambah data member')       
                        <a href="{{ route("members.create") }}" class="btn btn-dark" >
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table id="tablemembers" class="table card-table table-vcenter text-nowrap">
                                <thead>
                                    <tr>
                                        <th width="5%">No</th>
                                        <th>ID member</th>
...
@push('js')
    <script>
        $(function() {
            ...
            const table = $('#tablemembers').DataTable({
                scrollY: '500px',
                scrollX: true,
                scrollCollapse: true,
            ...
            $('#tablemembers').on('click', '.delete-member', function () {
